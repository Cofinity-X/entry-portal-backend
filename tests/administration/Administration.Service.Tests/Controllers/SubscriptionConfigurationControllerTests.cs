...
public class SubscriptionConfigurationControllerTests
{
    ...
    public async Task GetProcessStepData_WithValidData_ReturnsExpected()
    {
        ...
        //Act
        var result = await _controller.GetProcessStepsForSubscription(OfferSubscriptionId).ToListAsync();
    ...
    {
        //Act
        var result = await _controller.RetriggerProvider(OfferSubscriptionId);
    ...
    {
        //Act
        var result = await _controller.RetriggerCreateClient(OfferSubscriptionId);
    ...
    {
        //Act
        var result = await _controller.RetriggerCreateTechnicalUser(OfferSubscriptionId);
    ...
    {
        //Act
        var result = await _controller.RetriggerProviderCallback(OfferSubscriptionId);
